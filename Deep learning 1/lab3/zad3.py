...
if __name__ == '__main__':
    ...
    ds_train_all_classes = MNISTMetricDataset(mnist_download_root, split='train')
    ...
    train_all_classes_loader = DataLoader(
        ds_train,
        batch_size=64,
        shuffle=True,
        pin_memory=True,
    ...
    for epoch in range(epochs):
        ...
        if EVAL_ON_TEST or EVAL_ON_TRAIN:
            ...
            representations = compute_representations(model, train_all_classes_loader, num_classes, emb_size, device)
        if EVAL_ON_TRAIN:
